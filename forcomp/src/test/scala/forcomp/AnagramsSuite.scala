...
class AnagramsSuite {
  ...
  @Test
  def `sentence anagrams: []`: Unit = {
    val sentence = List()
    assertEquals(List(Nil), sentenceAnagrams(sentence))
  }

  @Test
  def `sentence anagrams: Linux rulez`: Unit = {
